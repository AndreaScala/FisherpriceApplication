...
import GossipingFaultDetection.GossipCheckThread4;
import GossipingFaultDetection.GossipSendThread4;
 ...
 * @author ilario
 */
@Singleton (name = "replica4")
public class ReplicaManagerBean4 implements ReplicaManagerBeanLocal {
    ...
    void init() {
        ...
        t1 = new Thread(new GossipSendThread4(name));
        t1.start();
        t2 = new Thread(new GossipCheckThread4(name));
        t2.start();
    }
